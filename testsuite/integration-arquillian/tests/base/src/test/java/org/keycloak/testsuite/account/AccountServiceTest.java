 ...
 */
public class AccountServiceTest extends AbstractTestRealmKeycloakTest {
    ...
    public void testUpdateProfile() throws IOException {
        ...
        updateError(user, 409, "Email already exists.");
        ...
        updateError(user, 409, "Username already exists.");
        ...
        updateError(user, 400, "You can't update your username as it is read only.");
    }
