...
public class AccountTest extends AbstractTestRealmKeycloakTest {
    ...
    public void testGetProfile() throws IOException {
        UserRepresentation user = SimpleHttp.doGet(getAccountUrl(), client).auth(tokenUtil.getToken()).asJson(UserRepresentation.class);
    ...
    public void testUpdateProfile() throws IOException {
        ...
        int status = SimpleHttp.doPost(getAccountUrl(), client).auth(tokenUtil.getToken()).json(user).asStatus();
