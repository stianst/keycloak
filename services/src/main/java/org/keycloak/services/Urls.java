...
public class Urls {
    ...
    public static URI accountApplicationsPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "applicationsPage").build(realmName);
    }
    ...
    public static URI accountPasswordPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "passwordPage").build(realmName);
    }

    public static URI accountFederatedIdentityPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "federatedIdentityPage").build(realmName);
    }
    ...
    public static URI accountTotpPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "totpPage").build(realmName);
    }
    ...
    public static URI accountLogPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "logPage").build(realmName);
    }

    public static URI accountSessionsPage(URI baseUri, String realmName) {
        return accountBase(baseUri).path(DeprecatedAccountFormService.class, "sessionsPage").build(realmName);
    }
